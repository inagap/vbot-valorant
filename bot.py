...
def print_banner(bot: triggerBot) -> None:
    os.system("cls")
    print(Style.BRIGHT + Fore.CYAN + "vbot | MaIn" + Style.RESET_ALL)
    print("----------INFO----------")
    print("--------> 1.1m <--------")
    print("----------KEYS----------")
    print("BOT ON/OFF KEY:         ", Fore.YELLOW + TRIGGER_KEY + Style.RESET_ALL)
    print("CHANGE MODE KEY:        ", Fore.YELLOW + SWITCH_KEY + Style.RESET_ALL)
    print("CHANGE CAPTURE AREA KEY:", Fore.YELLOW + GRABZONE_KEY_UP + "/" + GRABZONE_KEY_DOWN + Style.RESET_ALL)
    print("---------#STATS---------")
    print("BOT ON/OFF:             ", (Fore.GREEN if bot.toggled else Fore.RED) + ("ON" if bot.toggled else "OFF") + Style.RESET_ALL)
